...
<!-- Google Charts pour le pie chart -->
<script type="text/javascript" src="https://www.gstatic.com/charts/loader.js"></script>

<!-- Pie Chart - Utilisateurs enregistrés sur 7 jours -->
<script type="text/javascript">
  ...
  function drawChart()
  {
      ...
      var options = {
          title: 'Utilisateurs enregistrés sur les 7 derniers jours',
          titleTextStyle: {
            color: '#4e73df',
            fontSize: 18,
            bold: true
          },
          pieHole: 0.4, // Pour un donut chart moderne
          colors: ['#4e73df', '#1cc88a', '#36b9cc', '#f6c23e', '#e74a3b'],
          legend: {
            position: 'bottom',
            textStyle: { color: '#5a5c69', fontSize: 14 }
          },
...
<!-- Line Chart - Revenus mensuels avec Chart.js -->
<script type="text/javascript">
    const url = "{{ route('product.order.income') }}";

    // Style par défaut Chart.js (compatible avec Bootstrap)
    ...
    // Création du graphique en ligne après récupération des données via Axios
            ...
            var myLineChart = new Chart(ctx, {
                ...
                data: {
                    ...
                    datasets: [{
                        label: "Revenus",
                        lineTension: 0.3,
                        backgroundColor: "rgba(28, 200, 138, 0.1)", // Vert pâle
