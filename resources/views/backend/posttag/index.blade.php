...
@section('main-content')
 ...
 <div class="card shadow mb-4">
    ...
    <div class="card-header py-3">
      <h6 class="m-0 font-weight-bold text-primary float-left">Liste des tags d’articles</h6>
      <a href="{{route('post-tag.create')}}" class="btn btn-primary btn-sm float-right" data-toggle="tooltip" data-placement="bottom" title="Ajouter un utilisateur"><i class="fas fa-plus"></i> Ajouter un tag d’article</a>
    </div>
    <div class="card-body">
      <div class="table-responsive">
        ...
        @else
          <h6 class="text-center">Aucun tag d’article trouvé !!! Veuillez en créer un.</h6>
        @endif
      </div>
    </div>
</div>
...
@push('scripts')
  ...
  <script>
      ...
      function deleteData(id){
          // fonction vide, peut être utilisée plus tard
      }
  </script>
  <script>
