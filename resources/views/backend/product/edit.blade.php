      ...
      <form method="post" action="{{route('product.update',$product->id)}}">
        ...
        <div class="form-group">
          ...
          <select name="size[]" class="form-control selectpicker"  multiple data-live-search="true">
              ...
              <option value="XL"  @if( in_array( "XL",$data ) ) selected @endif>Très grand</option>
              @endforeach
          </select>
        </div>
        <div class="form-group">
        ...
        <div class="form-group">
          ...
          <select name="condition" class="form-control">
              ...
              <option value="hot" {{(($product->condition=='hot')? 'selected':'')}}>Tendance</option>
          </select>
        </div>
            ...
            if(cat_id !=null){
                ...
                $.ajax({
                    ...
                    success:function(response){
                        ...
                        var html_option="<option value=''>--Sélectionnez-en un--</option>";
                        if(response.status){
                            ...
                            if(response.data){
                                ...
                                console.log('pas de données en réponse');
                            }
                        }
                        else{
