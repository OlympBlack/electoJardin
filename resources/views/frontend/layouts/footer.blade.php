	...
	<!-- Start Footer Area -->
<footer class="footer text-dark" style="background-color: rgb(56, 60, 67);">
			...
			<div class="row">
				<div class="col-lg-5 col-md-6 col-12">
					...
					<div class="single-footer about">
						<div class="logo">
							<a href="index.html"><img src="{{asset('backend/img/logo2.png')}}" alt="logo" style="height: 70px;"></a>
						</div>
						@php
							$settings=DB::table('settings')->get();
						@endphp
						<p class="text">@foreach($settings as $data) {{$data->short_des}} @endforeach</p>
						<p class="call">Une question ? Appelez-nous 24h/24 et 7j/7 <span><a href="tel:123456789">@foreach($settings as $data) {{$data->phone}} @endforeach</a></span></p>
					</div>
					<!-- Fin widget unique -->
				</div>
	...
	<!-- Fin partie haute du pied de page -->
	<div class="copyright">
		<div class="container">
			<div class="inner">
				<div class="row">
