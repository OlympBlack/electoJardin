					...
					<div class="col-12">
						<div class="bread-inner">
							<ul class="bread-list">
								...
								<li class="active"><a href="">Les détails du produits</a></li>
							</ul>
						</div>
					</div>
				</div>
										...
										<div class="product-info">
											<div class="nav-main">
												...
												<ul class="nav nav-tabs" id="myTab" role="tablist">
													...
													<li class="nav-item"><a class="nav-link" data-toggle="tab" href="#reviews" role="tab">Les Avis</a></li>
												</ul>
												<!--/ End Tab Nav -->
											</div>
															...
															<div class="col-12">
																...
																<div class="comment-review">
																	<div class="add-review">
																		...
																		<p>Votre adresse mail ne sera pas publié. Les champs obligatoires sont indiqués</p>
																	</div>
																	<h4>Votre notre <span class="text-danger">*</span></h4>
																...
																<p class="text-center p-5">
																	Vous devrez vous <a href="{{route('login.form')}}" style="color:rgb(54, 54, 204)">connecter</a> OU <a style="color:blue" href="{{route('register.form')}}">S'inscrire</a>
																...
																<div class="ratting-main">
																	<div class="avg-ratting">
																		...
																		<span>Basé sur {{$product_detail->getReview->count()}} Commentaire(s)	</span>
																	</div>
