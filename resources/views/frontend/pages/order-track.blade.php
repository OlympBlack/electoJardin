    ...
    <section class="tracking_box_area section_gap py-5">
        <div class="container">
            <div class="tracking_box_inner">
                <p>Pour suivre votre commande, veuillez entrer votre identifiant de commande dans la case ci-dessous et appuyer sur le bouton « Suivre ». Cet identifiant vous a été donné sur votre reçu ainsi que dans l'email de confirmation que vous devriez avoir reçu.</p>
