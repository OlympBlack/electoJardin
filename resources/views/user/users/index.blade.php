...
<div class="card shadow mb-4">
    ...
    <div class="card-header py-3">
        ...
        <a href="{{route('users.create')}}" class="btn btn-primary btn-sm float-right" data-toggle="tooltip" data-placement="bottom" title="Ajouter un utilisateur">
...
<script>
    ...
    function deleteData(id){
        // Fonction de suppression (inutilisée ici)
    }
</script>
<script>
